      ...
      <>
              ...
              <div className='projects-bg'>
                <div className='container'>
                  ...
                  <div className='boxes'>
                    <div className='box'>
                    <img src={require('./img/guess.jpg')} alt='guess-the-number-photo' />
                    ...
                    <div className='box'>
                    <img src={require('./img/zorkington.png')} alt='zorkington-photo' />
                    <div className='text-container'>
                    ...
                    <section id='projects'>
                    <div className='box'>
                    <img src={require('./img/remock.png')} alt='remock-photo' />
                    <div className='text-container'>
                      <h1>Remock</h1>
                    ...
                    <div className='box'>
                    <img src={require('../imgs/tic-tac-toe.png')} alt='tic-tac-toe-photo' />
                    <div className='text-container'>
                      <h1>Tic-Tac-Toe</h1>
                    ...
                    <div className='box'>
                    <img src={require('../imgs/geo-vermonter.png')} alt='geo-vermonter-photo' />
                    <div className='text-container'>
                      <h1>Geo Vermonter</h1>
